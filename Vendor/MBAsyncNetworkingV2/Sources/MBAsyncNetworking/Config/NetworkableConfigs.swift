...
public enum NetworkableConfigsV2 {
    case `default`
    ...
    public func setServerTrustedAuthenticationChallenge(_ challenge: PinnableSessionDelegateV2) {
        SessionV2.shared.setServerTrustedAuthenticationChallenge(challenge)
    }

    public func setServerTrustedAuthenticationChallenge() {
